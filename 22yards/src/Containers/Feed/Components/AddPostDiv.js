        ...
        <div>
            ...
            <div className='d-flex flex-column p-2 mb-2' style={{backgroundColor:"white"}}>
                ...
                <div className='d-flex justify-content-around align-items-center'>
                    ...
                    <>
                      <label htmlFor='uploadVideoInAddPostRef1'>
                         <span className='Add-Images-In-AddPost-Button d-flex '>
                      ...
                      <input type="file" multiple id="uploadVideoInAddPostRef1" accept='video/*' style={{display:"none"}} onChange={addImagesToPost1}/>
                    </>
                    <img style={{height:"20px"}} src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAB4AAAAeCAYAAAA7MK6iAAAABmJLR0QA/wD/AP+gvaeTAAAATUlEQVRIie3XwQ2AIBAF0cHQE5XSgVAJMXalPSwGYjL/Pnl7Xfjb6tnv2voV7XNYTpRwCxwzsbCwsLCwsLCwsLDwXjj+ScAg8Xx2yaq9KmwHhEWFW+EAAAAASUVORK5CYII="></img>
                    <>
                      <label htmlFor='uploadLocationInAddPostRef1'>
                        <span className='Add-Images-In-AddPost-Button d-flex '>
                      ...
                      <input type="file" multiple id="uploadLocationInAddPostRef1" accept='image/*' style={{display:"none"}} onChange={addImagesToPost1}/>
                    </> 
                </div>
            </div> 
            {/* <div className='d-flex mb-1'>
