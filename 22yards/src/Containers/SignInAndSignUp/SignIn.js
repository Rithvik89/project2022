    ...
    return(
        <div className="signIn-signUp-Page-Container">
           <div className="signIn-signUp-Container">
                ...
                <Input type="text" onChange={handleMailInputChange} placeholder="username" className="input-element-signIn-signUp"/>
                <div className="password-container">
                    <Input type={passwordDisplayType} onChange={handlePasswordInputChange} placeholder="Password" className="input-element-signIn-signUp-password"/>
